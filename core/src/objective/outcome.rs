...
//!
//! The fields of an [`Outcome`] are used by the associated [`Codomain`]
...
//! ## Codomain design
//!
//! The associated [`Codomain`] type of an [`Outcome`] is automatically
...
/// the [`Codomain`] (objectives, constraints, cost,
