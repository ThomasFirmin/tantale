...
impl<PSol,SolId, Obj, Opt, Cod, Out, SInfo, Info> BatchResults<PSol,SolId, Obj, Opt, Cod, Out, SInfo, Info>
where
    PSol: Partial<SolId,Obj,SInfo>,
    SolId: Id,
    Obj: Domain,
    ...
    Info: OptInfo,
{
    ...
    pub fn add(&mut self, pair:PartPair<PSol,PSol::Twin<Opt>>,out:Arc<Out>,y:Arc<Cod::TypeCodom>){
        self.rbatch.add(
