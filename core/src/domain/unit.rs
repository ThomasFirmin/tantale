...
use crate::domain::{
    Domain, TypeDom, base::{BaseDom, BaseTypeDom}, bool::Bool, bounded::{Bounded, BoundedBounds, DomainBounded}, cat::Cat, derrors::OntoError, onto::{Onto, OntoDom}, sampler::uniform
};
