...
pub mod solution;
pub use solution::{Fidelity, BasePartial, Computed, Id, ParSId, Partial, SId, SolInfo, Solution};
...
pub use crate::objective::{
    ...
    CostConstCodomain, CostConstMultiCodomain, CostMultiCodomain, Criteria, Multi,
