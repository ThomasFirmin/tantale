...
use crate::{
    ...
    solution::{Id, OutBatch, SolutionShape, Uncomputed,HasY}
};
    ...
    CompShape<Scp,PSol,SolId,Op::SInfo,Op::Cod,Out>: SolutionShape<SolId,Op::SInfo> + HasY<Op::Cod,Out>,
{
    ...
    fn save_batch(&self,computed: &CompBatch<SolId,Op::SInfo,Op::Info,Scp,PSol,Op::Cod,Out>,outputed: &OutBatch<SolId,Op::Info,Out>,scp: &Scp,cod: &Op::Cod);
}
    ...
    CompShape<Scp,PSol,SolId,Op::SInfo,Op::Cod,Out>: SolutionShape<SolId,Op::SInfo> + HasY<Op::Cod,Out>,
{
    ...
    fn save_batch_dist(&self,computed: &CompBatch<SolId,Op::SInfo,Op::Info,Scp,PSol,Op::Cod,Out>,outputed: &OutBatch<SolId,Op::Info,Out>,scp: &Scp,cod: &Op::Cod);
}
