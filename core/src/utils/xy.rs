...
use crate::{
    BaseSol, Computed, Domain, Dominate, FidelitySol, HasX, HasY, Id, Orderable, Outcome, SolInfo, StepId, TypeCodom, Uncomputed, domain::codomain::{
        ElemConstCodomain, ElemConstMultiCodomain, ElemCostCodomain, ElemCostConstCodomain, ElemCostConstMultiCodomain, ElemCostMultiCodomain, ElemMultiCodomain, ElemSingleCodomain
...
impl<SolObj, SolId, Obj, SInfo, Out> YToNdArray
