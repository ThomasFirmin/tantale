...
fn test_serde_batchevaluator() {
    ...
    > as MonoEvaluate<
        ...
        OutBatchEvaluate<SId, _, _, Lone<BaseSol<SId, Mixed, EmptyInfo>, SId, Mixed, EmptyInfo>, _>,
...
fn test_serde_fidbatchevaluator() {
    ...
    > as MonoEvaluate<
        ...
        OutBatchEvaluate<StepSId, _, _, Lone<FidelitySol<StepSId, Mixed, EmptyInfo>, StepSId, Mixed, EmptyInfo>, _>,
    >>::evaluate(&mut neval, &obj, &cod, &mut stop, &mut acc);
