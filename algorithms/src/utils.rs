...
use tantale_core::{BaseSol, Batch, CompAcc, CompShape, FidelitySol, LinkOpt, Objective, RawObj, SId, StepSId, Stepped, searchspace::SShape};
...
pub type BCompShape<Scp, Out, SInfo> = CompShape<SShape<Scp, BaseSol<SId, LinkOpt<Scp>, SInfo>,SId, SInfo>, SId, SInfo, Out>;
/// A type alias for a [`Batch`] of [`BCompShape`]s, identified with [`SId`].
pub type BatchBCompShape<Scp, Out, Info, SInfo> = Batch<SId, SInfo, Info, BCompShape<Scp, Out, SInfo>>;
/// A type alias for an [`Accumulator`](tantale_core::Accumulator) of [`BCompShape`]s.
pub type BCompAcc<Scp,Out, SInfo> = CompAcc<SShape<Scp, BaseSol<SId, LinkOpt<Scp>, SInfo>,SId, SInfo>,SId,SInfo, Out>;

/// A type alias for a [`CompShape`] made of [`Computed`](tantale_core::Computed) [`FidelitySol`], identified with [`StepSId`].
pub type FCompShape<Scp, Out, SInfo> = CompShape<SShape<Scp, FidelitySol<StepSId, LinkOpt<Scp>, SInfo>,StepSId, SInfo>, StepSId, SInfo, Out>;
/// A type alias for a [`Batch`] of [`FCompShape`]s, identified with [`StepSId`].
pub type BatchFCompShape<Scp, Out, Info, SInfo> = Batch<StepSId, SInfo, Info, FCompShape<Scp, Out, SInfo>>;
/// A type alias for an [`Accumulator`](tantale_core::Accumulator) of [`FCompShape`]s.
pub type FCompAcc<Scp,Out, SInfo> = CompAcc<SShape<Scp, FidelitySol<StepSId, LinkOpt<Scp>, SInfo>,StepSId, SInfo>, StepSId, SInfo, Out>;
