...
fn test_python_function() {
    ...
    let obj = init_python!(
        Stepped,
        sp_ms_nosamp,
        "/tests/test_pytantale_stepped_async/function_fid_async.py",
        "function_fid_async",
        "objective",
        "/tests/test_pytantale_stepped_async/function_fid_async.py",
        "function_fid_async",
    ...
    let mut exp = load!(mono, MoAsha<NSGA2Selector,_>, Calls, (sp, cod), obj2, (rec, check));
    ...
    let exp = load!(mono, MoAsha<NSGA2Selector,_>, Calls, (sp, cod), obj3, (rec, check));
