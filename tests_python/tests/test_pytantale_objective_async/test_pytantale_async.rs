...
fn test_python_function() {
    ...
    let obj = init_python!(
        ...
        "/tests/test_pytantale_objective_async/function_async.py", "function_async", "objective",
        "/tests/test_pytantale_objective_async/function_async.py", "function_async", "MyOutcome",
